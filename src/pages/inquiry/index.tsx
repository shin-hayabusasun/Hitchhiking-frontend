...
return (
        <div className="min-h-screen bg-gray-50 text-gray-800 pb-10 font-sans">
            {/* ① ヘッダー */}
            {/* TitleHeaderのデザインが不明なため、写真に合わせて直接実装しています */}
            <header className="bg-white p-4 flex items-center shadow-sm sticky top-0 z-10">
                ...
                <h1 className="text-lg font-bold ml-2">お問い合わせ</h1>
            </header>
