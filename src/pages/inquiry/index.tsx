...
export function InquiryPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans text-gray-800">
      ...
      {/* メインコンテンツ: 中央寄せ max-w-2xl */}
      <main className="max-w-2xl mx-auto w-full p-4 space-y-6 pb-20">
        
        {/* お問い合わせフォームカード */}
        <section className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 space-y-5">
