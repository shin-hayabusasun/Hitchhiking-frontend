...
export function PointOrdersPage() {
  ...
  return (
    ...
    <div className="w-full min-h-screen bg-gray-100 flex flex-col items-center">
      ...
      {/* ★ 修正：max-w-2xl に変更し、元のデザイン要素（border, ring, gradient）を維持したまま中央寄せ */}
      <div className="w-full max-w-2xl min-h-screen shadow-2xl flex flex-col font-sans border-[8px] border-white relative ring-1 ring-gray-200 bg-gradient-to-b from-sky-200 to-white overflow-y-auto">
        <TitleHeader title="注文履歴" backPath="/points" />
        
        <main className="max-w-3xl mx-auto p-4 md:p-6">
          {/* フィルタリングボタンエリア：デザインとボタンサイズをそのまま維持 */}
...
export default PointOrdersPage;import { useEffect, useState } from 'react';
import { TitleHeader } from '@/components/TitleHeader';
import { OrderCard, OrderItemResponse } from '@/components/point/OrderCard';
import { API_BASE_URL } from '@/config/api';
